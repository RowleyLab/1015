...
This is the lab to accompany CHEM 1010.
...
\paragraph{Registration Restriction:}
Intensive English Program majors may not enroll

\paragraph{General Education Category:}
Chemistry and Physics

\paragraph{Course Materials:} ~

\emph{Demonstrations and Experiments, Introductory Chemistry Laboratory} by H. Samha 2020, 4th edition (Available at the SUU bookstore and on canvas)
...
\begin{itemize}
  \item Demonstrate the skills to perform basic laboratory techniques
  \item Demonstrate basic understanding of hte process of scientific measurement
  \item Demonstrate in practice the theoretical principles taught in CHEM 1010, such as moles, chemical reactions, solubility, and gas laws
\end{itemize}

\section*{Laboratory Work}
Before lab, you are expected to have read the handout of your experiment as well as review your lecture notes from class. Come prepared to carry out the lab or learn from the demonstration for each week. After each lab or demonstrationn, complete and turn in the associated lab report.

\noindent Please follow all safety procedures, especially by wearing safety glasses or goggles. When leaving the lab, please make sure it is in the same clean condition as it was when you arrived. Be respectful of others.
...
\noindent
Note that this means that the lab work accounts for about 72\% of your final grade, while the final exam accounts for about 28\%.
...
All reports are to be turned in on the day of the next lab period. Late work will not be accepted.
